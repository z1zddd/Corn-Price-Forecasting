"""Deployment vote aggregation operators over completed rolling prediction streams."""
...
class BestDeploymentEnsemble:
    """Aggregate selected rolling prediction streams into a fixed deployment vote."""

    def __init__(self, spec: DeploymentEnsembleSpec) -> None:
        self.spec = spec
        self.model_family = "deployment_ensemble"
        self.operator_kind = "aggregation"
        self.aggregation_kind = "deployment_vote"
    ...
    def _build_aligned_matrix(self, predictions) -> tuple[Any, list[dict[str, Any]]]:
        import pandas as pd
    ...
    def _score_matrix(self, matrix) -> Any:
        import numpy as np
...
DeploymentVoteAggregator = BestDeploymentEnsemble
