...
_FACTORIES = {
    ...
    "gru": ("corn_forecast.operator.model.families.sequence.gru", "create_gru"),
    "transformer": ("corn_forecast.operator.model.families.sequence.transformer", "create_transformer"),
    "patchtst": ("corn_forecast.operator.model.families.sequence.patchtst", "create_patchtst"),
