...
_FACTORIES = {
    "lstm": ("models.sequence.lstm", "create_lstm"),
    "gru": ("models.sequence.gru", "create_gru"),
    "transformer": ("models.sequence.transformer", "create_transformer"),
    "patchtst": ("models.sequence.patchtst", "create_patchtst"),
    "itransformer": ("models.sequence.itransformer", "create_itransformer"),
    "dlinear": ("models.sequence.dlinear", "create_dlinear"),
    "dual_stream_lstm": ("models.sequence.dual_stream_lstm", "create_dual_stream_lstm"),
}
